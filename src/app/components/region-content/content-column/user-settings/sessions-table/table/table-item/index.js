...
export default connect('mobileViewportState', actions)(({ ip, date, mobileViewportState }) => {
  let isCurrentSession = date === 'current'
  let currentText = mobileViewportState ? 'Close others' : 'Terminate all other sessions'
  return (
    <li>
